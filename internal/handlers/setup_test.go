...
func getRoutes() http.Handler {
	...
	mux.Get("/admin/reservations-calendar", Repo.AdminReservaionsCalendar)
	mux.Post("/admin/reservations-calendar", Repo.AdminPostReservaionsCalendar)
